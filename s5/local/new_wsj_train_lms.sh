...
#. utils/parse_options.sh || exit 1; #not needed since I deleted the suffix option

dir=$1		#data/local/lm
srcdir=$2	#data/local/dict${dict_suffix}_larger
#mkdir -p $dir #already created
